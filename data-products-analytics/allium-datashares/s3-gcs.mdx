...
icon: "database"
description: "Regular data delivery to file buckets across different regions and cloud providers, offering flexible and customizable data access solutions"
---
...
<Info>
  Our data is in the Iceberg format, where most of the industry is moving
  towards for maximum interoperability across all data infrastructure vendors
</Info>
