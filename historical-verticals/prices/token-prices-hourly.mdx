---
title: "Token Prices"
description: "Fetch hourly token prices of tokens to power your analytic needs."
---
...
| address        | Token contract address equivalent on the blockchain.<br/>For native tokens on EVM chains, they will be represented by the zero address. | 0x0000000000000000000000000000000000000000 |
