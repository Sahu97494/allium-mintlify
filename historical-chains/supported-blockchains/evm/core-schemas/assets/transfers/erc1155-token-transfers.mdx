...
|--------------------------|------------------|-------------------------------------------------------------------------------------------------|
| event_type               | VARCHAR          | Type of transfer event for ERC1155 tokens. This can either be `single_transfer` or `batch_transfer`. |
...
| token_id                 | VARCHAR          | The token ID of the token.                                                                      |
| raw_amount_str           | VARCHAR          | Amount of token transferred, unnormalized, in string (to retain precision).                      |
...
| transaction_hash         | VARCHAR          | The transaction hash that this transfer belongs to.                                            |
