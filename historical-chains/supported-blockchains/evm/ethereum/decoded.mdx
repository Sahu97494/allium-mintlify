...
<table><thead><tr><th width="312">Table</th><th width="582">Description</th></tr></thead><tbody><tr><td><code>ethereum.decoded.logs</code> </td><td>Decoded event logs with params in JSON format.</td></tr><tr><td><code>ethereum.decoded.traces</code> </td><td>Decoded traces with params in JSON format.</td></tr></tbody></table>
