...
* [**Uniswap V2 Events**](/historical-chains/supported-blockchains/evm/ink/dex/events/uniswap-v2-events): Contains swap, Sync, Mint, Burn events from Uniswap V2 Liquidity Pools

* [**Uniswap V3 Events**](/historical-chains/supported-blockchains/evm/ink/dex/events/uniswap-v3-events): Contains swap, Sync, Mint, Collect, Burn, Initialize, Flash events from Uniswap V3 Liquidity Pools

* [**Uniswap V4 Events**](/historical-chains/supported-blockchains/evm/ink/dex/events/uniswap-v4-events): Contains OperatorSet, OwnershipTransferred, ProtocolFeeControllerUpdated, Transfer, ProtocolFeeUpdated, Initialize, Swap, ModifyLiquidity, and Donate events from Uniswap V4 PoolManager
