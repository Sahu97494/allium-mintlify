...
The decoded schema includes decoded event logs on Zora.

Our Zora decoded schema contains the following tables:

<table><thead><tr><th width="312">Table</th><th width="582">Description</th></tr></thead><tbody><tr><td><code>zora.decoded.logs</code> </td><td>Decoded event logs with params in JSON format.</td></tr></tbody></table>
