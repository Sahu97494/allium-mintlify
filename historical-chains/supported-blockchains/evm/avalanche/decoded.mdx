...
The decoded schema includes decoded event logs and trace call data.

Our decoded schema contains the following tables:

| Table                | Description                                            |
| -------------------- | ------------------------------------------------------ |
| chain.decoded.logs   | Decoded event logs with params in JSON format.         |
| chain.decoded.traces | Decoded traces input and output params in JSON format. |
