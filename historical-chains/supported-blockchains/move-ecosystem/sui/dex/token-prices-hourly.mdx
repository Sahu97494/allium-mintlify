...
| median\_safe\_price  | FLOAT             | A more reliable price metric that only considers trades worth $100+ USD, filtering out potentially misleading small transactions. For major tokens, it typically stays within 5% of the regular median price, though smaller tokens may show larger variations due to lower liquidity.                                               |
