...
The Prices API provides real-time token prices and historical price data for Solana tokens. Prices are derived from Allium's real-time DEX trade feeds and aggregated at minute, hour, and day granularities.
