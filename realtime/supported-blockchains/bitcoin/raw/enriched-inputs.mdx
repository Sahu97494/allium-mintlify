...
This table is indexed on address0, spent_utxo_id, block_number, block_timestamp, transaction_hash. Query for a specific row with any of these columns to see faster query results.

| Column Name            | Description                                                           | Example                                                              |
| ---------------------- | --------------------------------------------------------------------- | -------------------------------------------------------------------- |
| transaction_hash       | Transaction hash of input utxo                                        | cda25c1ccefcc07bdde18b3ceb372e46bead3c1e2dba2284e5e598f6ef770179     |
...
| spent_transaction_hash | The transaction where this input utxo was spent (as an output)        | b425e59215c510fdd6881660230046b640426ea60a3fb7eaeb3ddb7984f14c4e     |
| spent_output_index     | Index of output from spent transaction.                               | 194                                                                  |
