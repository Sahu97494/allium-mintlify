...
| -------- | ------------------------- | ------------------ |
| DEX      | dex_swap                  | :white_check_mark: |
| DEX      | dex_add_liquidity         | :white_check_mark: |
| DEX      | dex_remove_liquidity      | :white_check_mark: |
| DEX      | dex_deploy_liquidity_pool | :white_check_mark: |
| NFT      | nft_buy                   | :white_check_mark: |
| NFT      | nft_sell                  | :white_check_mark: |
| NFT      | nft_mint                  | :white_check_mark: |
